...
// Copied from timeserieslinechart, because I was unable to create a New
// chart with only linechart.WithXLabelFormatter(HourTimeLabelFormatter())
// while keeping other params the same.

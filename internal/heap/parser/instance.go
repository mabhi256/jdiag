...
// 		if slices.Contains(threadFieldNames, fieldName) {
// 			foundFields++
// 		}
// 	}
...
// 	arrayReg *registry.ArrayRegistry, identifierSize uint32) *registry.ThreadInstanceData {
...
// func extractThreadFields(threadData *registry.ThreadInstanceData, fieldValues map[string]any,
// 	stringReg *registry.StringRegistry, arrayReg *registry.ArrayRegistry) {
...
// 	stringReg *registry.StringRegistry, arrayReg *registry.ArrayRegistry, identifierSize uint32) {

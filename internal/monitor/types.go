...
type JVMSnapshot struct {
	...
	// GC Management
	YoungGCManagedPools []string // Memory pools managed by young GC
	OldGCManagedPools   []string // Memory pools managed by old GC
	InvalidGCs          []string // GCs that are no longer valid
	...
	OldGCEfficiency     float64 // Memory freed / time spent (MB/ms)
	...
	CurrentThreadAllocatedBytes int64 // Memory allocated by current thread
	...
	ThreadCpuTimeSupported              bool // Whether thread CPU time is supported
	ThreadCpuTimeEnabled                bool // Whether thread CPU time monitoring is enabled
	ThreadAllocatedMemorySupported      bool // Whether thread memory allocation tracking is supported
	ThreadAllocatedMemoryEnabled        bool // Whether thread memory allocation tracking is enabled
	ThreadContentionMonitoringSupported bool // Whether thread contention monitoring is supported
	ThreadContentionMonitoringEnabled   bool // Whether thread contention monitoring is enabled
	ObjectMonitorUsageSupported         bool // Whether object monitor usage info is supported
	SynchronizerUsageSupported          bool // Whether synchronizer usage info is supported
	...
	// Swap space
	TotalSwapSize int64 // Total swap space
	FreeSwapSize  int64 // Free swap space
	...
	ProcessName string // Process name (usually PID@hostname)
	...
	// JVM configuration
	JVMArguments           []string // All JVM startup arguments
	JavaClassPath          string   // Java classpath
	JavaLibraryPath        string   // Java library path
	BootClassPath          string   // Boot classpath (if supported)
	BootClassPathSupported bool     // Whether boot classpath is supported
